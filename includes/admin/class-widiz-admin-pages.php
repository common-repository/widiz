...
class Widiz_Admin_Pages
{
    ...
    public function enqueue_admin_css_js()
    {
        ...
        // Main Plugin Page
        if ($this->plugin_screen_hook_suffix['widiz_crm'] == $screen->id) {
            /* Admin Styles */
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        $this->plugin_screen_hook_suffix['widiz_crm'] = add_menu_page(
            __('Widiz', 'widiz'),
            __('Widiz', 'widiz'),
            'manage_options',
